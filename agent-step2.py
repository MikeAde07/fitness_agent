...
def get_exercise_info(muscle_group: str) -> str:
    ...
    #could've been database call, object has been put in place for mock data
    exercise_data = {
        "chest": [
...
fitness_agent = Agent(
    ...
    Use the calculate_calories tool to provide nutritional guidance. 
...
async def main() :
    ...
    queries = [
        ...
        "I'm 30 years old, male, 175cm tall, and weigh 80 kg. How many calories should I eat to lose weight?"
    ]
    ...
    for query in queries:
        ...
        # passing each query to the fitness agent
